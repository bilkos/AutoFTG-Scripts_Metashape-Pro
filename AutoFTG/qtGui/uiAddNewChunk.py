...
################################################################################
## Form generated from reading UI file 'uiAddNewChunk.ui'
##
...
class Ui_MainWindow(QtWidgets.QMainWindow):
	def __init__(self, parent):
		...
		self.resize(680, 560)
		self.setMinimumSize(QSize(670, 560))
		font = QFont()
		...
		self.actionChunkEditor = QAction(self)
		self.actionChunkEditor.setObjectName(u"actionChunkEditor")
		icon1 = QIcon()
		icon1.addFile(u":/icons/icons8-product-documents-50.png", QSize(), QIcon.Normal, QIcon.Off)
		self.actionChunkEditor.setIcon(icon1)
		self.actionChunkEditor.setText(u"Chunk Settings")
		self.actionChunkEditor.setIconText(u"Chunk Settings")
#if QT_CONFIG(tooltip)
		self.actionChunkEditor.setToolTip(u"Chunk Settings")
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
		self.actionChunkEditor.setStatusTip(u"Open chunk setting editor..")
#endif // QT_CONFIG(statustip)
		font1 = QFont()
		self.actionChunkEditor.setFont(font1)
		self.actionCameraEditor = QAction(self)
		self.actionCameraEditor.setObjectName(u"actionCameraEditor")
		icon2 = QIcon()
		icon2.addFile(u":/icons/icons8-cameras-50.png", QSize(), QIcon.Normal, QIcon.Off)
		self.actionCameraEditor.setIcon(icon2)
		self.actionCameraEditor.setText(u"Cameras Editor")
		self.actionCameraEditor.setIconText(u"Cameras Editor")
#if QT_CONFIG(tooltip)
		self.actionCameraEditor.setToolTip(u"Cameras Editor")
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
		self.actionCameraEditor.setStatusTip(u"Open camera editor...")
#endif // QT_CONFIG(statustip)
		self.actionCameraEditor.setFont(font1)
		...
		icon3 = QIcon()
		icon3.addFile(u":/icons/icons8-copy-to-folder-50.png", QSize(), QIcon.Normal, QIcon.Off)
		...
		icon11 = QIcon()
		icon11.addFile(u":/icons/icons8-my-location-50.png", QSize(), QIcon.Normal, QIcon.Off)
		self.checkBox_2.setIcon(icon11)
		...
		icon12 = QIcon()
		icon12.addFile(u":/icons/icons8-add-tab-50.png", QSize(), QIcon.Normal, QIcon.Off)
		self.cbChunkSettings.addItem(icon12, u"Default")
		icon13 = QIcon()
		icon13.addFile(u":/icons/kalota_m.png", QSize(), QIcon.Normal, QIcon.Off)
		self.cbChunkSettings.addItem(icon13, u"KALOTA")
		icon14 = QIcon()
		icon14.addFile(u":/icons/stopnca_o.png", QSize(), QIcon.Normal, QIcon.Off)
		self.cbChunkSettings.addItem(icon14, u"STOPNICA - IZKOP")
		icon15 = QIcon()
		icon15.addFile(u":/icons/stopnca_s.png", QSize(), QIcon.Normal, QIcon.Off)
		self.cbChunkSettings.addItem(icon15, u"STOPNICA - B.BET.")
		...
		self.cbChunkSettings.setFont(font5)
		...
		icon16 = QIcon()
		icon16.addFile(u":/icons/icons8-in-progress-96.png", QSize(), QIcon.Normal, QIcon.Off)
		self.checkBox_3.setIcon(icon16)
		...
		icon17 = QIcon()
		icon17.addFile(u":/icons/icons8-images-folder-50.png", QSize(), QIcon.Normal, QIcon.Off)
		...
		icon18 = QIcon()
		icon18.addFile(u":/icons/icons8-synchronize-50.png", QSize(), QIcon.Normal, QIcon.Off)
		...
		icon19 = QIcon()
		icon19.addFile(u":/icons/icons8-enter-50.png", QSize(), QIcon.Normal, QIcon.Off)
		...
		icon20 = QIcon()
		icon20.addFile(u":/icons/icons8-folder-tree-50.png", QSize(), QIcon.Normal, QIcon.Off)
		font7 = QFont()
		font7.setBold(True)
		font7.setWeight(75)
		...
		__qtreewidgetitem.setIcon(0, icon20);
		self.treeWidget.setHeaderItem(__qtreewidgetitem)
		icon21 = QIcon()
		icon21.addFile(u":/icons/icons8-folder-50.png", QSize(), QIcon.Normal, QIcon.Off)
		font8 = QFont()
		...
		__qtreewidgetitem1.setIcon(0, icon21);
		...
		__qtreewidgetitem3.setIcon(0, icon21);
		...
		self.menuSettings.setTitle(u"Settings")
		self.setMenuBar(self.menubar)
		self.statusbar = QStatusBar(self)
		self.statusbar.setObjectName(u"statusbar")
		self.statusbar.setMinimumSize(QSize(0, 26))
		...
		QWidget.setTabOrder(self.pushButton, self.treeWidget)
		QWidget.setTabOrder(self.treeWidget, self.cbChunkSettings)
		QWidget.setTabOrder(self.cbChunkSettings, self.comboBox_2)
		...
		QWidget.setTabOrder(self.checkBox_3, self.pushButton_3)
		QWidget.setTabOrder(self.pushButton_3, self.pushButton_2)

		self.menubar.addAction(self.menuSettings.menuAction())
		self.menuSettings.addAction(self.actionChunkEditor)
		self.menuSettings.addAction(self.actionCameraEditor)

		self.cbChunkSettings.currentIndexChanged.connect(self.label_6.setNum)
		self.cbChunkSettings.currentIndexChanged.connect(self.label_7.setText)
		self.checkBox_2.toggled.connect(self.checkBox.setEnabled)
		self.checkBox_2.toggled.connect(self.checkBox.setChecked)
