...
class Ui_DialogBatchChunk(object):
    def setupUi(self, DialogBatchChunk):
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icons/icons8-add-tab-50.png", QSize(), QIcon.Normal, QIcon.Off)
        self.cbChunkSettings.addItem(icon5, u"Default")
        icon6 = QIcon()
        icon6.addFile(u":/icons/kalota_m.png", QSize(), QIcon.Normal, QIcon.Off)
        self.cbChunkSettings.addItem(icon6, u"KALOTA")
        icon7 = QIcon()
        icon7.addFile(u":/icons/stopnca_o.png", QSize(), QIcon.Normal, QIcon.Off)
        self.cbChunkSettings.addItem(icon7, u"STOPNICA - IZKOP")
        icon8 = QIcon()
        icon8.addFile(u":/icons/stopnca_s.png", QSize(), QIcon.Normal, QIcon.Off)
        self.cbChunkSettings.addItem(icon8, u"STOPNICA - B.BET.")
        ...
        icon13 = QIcon()
        icon13.addFile(u":/icons/icons8-live-photos-96.png", QSize(), QIcon.Normal, QIcon.Off)
        self.comboBox_2.addItem(icon13, u"Cam 3")
        icon14 = QIcon()
        icon14.addFile(u":/icons/icons8-aperture-50.png", QSize(), QIcon.Normal, QIcon.Off)
        self.comboBox_2.addItem(icon14, u"Cam 4")
        icon15 = QIcon()
        icon15.addFile(u":/icons/icons8-video-stabilization-50.png", QSize(), QIcon.Normal, QIcon.Off)
        self.comboBox_2.addItem(icon15, u"Cam 5")
        icon16 = QIcon()
        icon16.addFile(u":/icons/icons8-quadcopter-50.png", QSize(), QIcon.Normal, QIcon.Off)
        self.comboBox_2.addItem(icon16, u"Cam 6")
